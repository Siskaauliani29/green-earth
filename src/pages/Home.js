      ...
      <div className="inspire-section">
        ...
        <div className="card-container">
          <div className="card">
            ...
            <h4>Urban Farming</h4>
            <p1>Mari mulai kebun kecil di rumah untuk konsumsi sehat dan ramah lingkungan.</p1>
          </div>
          <div className="card">
            <img src="https://cdn-icons-png.flaticon.com/512/3062/3062634.png" alt="icon" />
            <h4>Kompos Mandiri</h4>
            <p2>Ubah sampah organik menjadi pupuk alami yang menyuburkan tanaman.</p2>
          </div>
          <div className="card">
            <img src="https://cdn-icons-png.flaticon.com/512/3163/3163130.png" alt="icon" />
            <h4>Kurangi Plastik</h4>
            <p3>Gunakan barang ramah lingkungan untuk menjaga bumi lebih bersih.</p3>
          </div>
        </div>
      </div>
    </div>
